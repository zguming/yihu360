...
public class Create_test_suit_2Bean implements Serializable {
	...
	public String toString() {
		return "Create_test_suit_2Bean [id=" + id + ", test_type=" + test_type
				+ ", test_type_name=" + test_type_name + ", test_time_limit="
				+ test_time_limit + ", used_time=" + used_time + ", title="
				+ title + ", sub_title=" + sub_title + ", groups="
	...
	public class questions implements Serializable {
		...
		private Boolean isError = false; // 答案是否正确
		...
		@Override
		public String toString() {
			return "questions [no=" + no + ", cuotijiexi_questionNO="
					+ cuotijiexi_questionNO + ", type=" + type + ", content="
					+ content + ", img=" + img + ", opt="
					+ Arrays.toString(opt) + ", correct="
					+ Arrays.toString(correct) + ", answer=" + answer
					+ ", answertime=" + answertime + ", analyze=" + analyze
					+ ", points=" + Arrays.toString(points) + ", duoxuan="
					+ duoxuan + "]";
		}
	...
	public class analyze implements Serializable {
		...
		public Create_test_suit_2Bean.img getImg() {
			return img;
		}

		public void setImg(Create_test_suit_2Bean.img img) {
			this.img = img;
		}
