...
public class UniversalMediaController extends FrameLayout {
    ...
    private LinearLayout ll_seekbar_container;
...
//    private boolean mFullscreenEnabled = false;
    ...
    private void initControllerView(View v) {
        ...
        ll_seekbar_container = (LinearLayout) findViewById(R.id.ll_seekbar_container);
    ...
    private View.OnClickListener mBackListener = new View.OnClickListener() {
        public void onClick(View v) {
            if (mIsFullScreen) {
                ...
                myBackListener.onClick();
            }

        }
    };

    public void setMyBackListener(MyBackListener myBackListener) {
        this.myBackListener = myBackListener;
    }
    ...
    public void setMyFullListener(MyFullListener myFullListener) {
        this.myFullListener = myFullListener;
    }

    private MyFullListener myFullListener;

    public interface MyFullListener {
        void onClick();
    }
...
//    }
    ...
    public void hideSeekBar() {
        ll_seekbar_container.setVisibility(View.GONE);
    }
    public void showSeekBar() {
        ll_seekbar_container.setVisibility(View.VISIBLE);
    }
}
