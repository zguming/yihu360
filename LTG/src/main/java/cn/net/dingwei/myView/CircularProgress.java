...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.bgcolor_1);
        mColors[1] = context.getResources().getColor(R.color.bgcolor_2);
        mColors[2] = context.getResources().getColor(R.color.bgcolor_1);
        mColors[3] = context.getResources().getColor(R.color.bgcolor_2);
