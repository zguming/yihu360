...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private float dividerWidth = 0.1f;
	...
	private MyTabBack myBack;

	public interface MyTabBack {
		public void back(int index);

	}

	public void setListener(MyTabBack myBack) {
		this.myBack = myBack;
	}
	...
	public void setListJump(List<Integer> jumps){
		this.jumps=jumps;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(lineLeft+indicator_leftpadding, height - indicatorHeight, lineRight-indicator_rightpadding, height,
				rectPaint);
		...
		for (int i = 0; i < tabCount - 1; i++) {
			...
			canvas.drawLine(tab.getRight(), dividerPadding + 20,
					tab.getRight(), height - dividerPadding - 20, dividerPaint);
		}
	}
	...
	private int indicator_leftpadding=0;
	private int indicator_rightpadding=0;
	/**
	 * 设置只是器线 左右间距
	 * @param padding  像素
	 */
	public void setIndicator_leftAndRight_padding(int padding){
		indicator_leftpadding=padding;
		indicator_rightpadding=padding;
		//invalidate();
	}
}
