 ...
 *
 */
public class MyLinear_readquestion extends LinearLayout {
	...
	private Boolean isCanScroll=false;	//是否可滑动

	private Reading_QuestionsActivity activity;

	public MyLinear_readquestion(Context context) {
		this(context, null, 0);
	}

	public MyLinear_readquestion(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public MyLinear_readquestion(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setActivity(Reading_QuestionsActivity activity) {
