...
public class Get_situationBean implements Serializable{
	...
	public String toString() {
		return "Get_situationBean [exam=" + exam + ", k=" + k + ", tot_r="
				+ tot_r + ", exe_c=" + exe_c + ", exe_s=" + exe_s + ", exe_r="
				+ exe_r + ", wro_c=" + wro_c + ", wro_t=" + wro_t + ", wro_r="
				+ wro_r + ", wro_w=" + wro_w + ", points="
	...
	public class points{
		...
		@Override
		public String toString() {
			return "points [id=" + id + ", tot_r=" + tot_r + ", exe_c=" + exe_c
					+ ", exe_s=" + exe_s + ", exe_r=" + exe_r + ", wro_c="
					+ wro_c + ", wro_t=" + wro_t + ", wro_r=" + wro_r
					+ ", wro_w=" + wro_w + "]";
		}
