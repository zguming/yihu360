...
public class MyImageDown_width extends AsyncTask<String, integer, Boolean> {
	private ImageView imageView;
	private String imagePath;
	private String imageUrl;
	private int ViewWidth;//ImageView 的宽
	public MyImageDown_width(ImageView imageView,String imageUrl,int ViewWidth,Context context) {
