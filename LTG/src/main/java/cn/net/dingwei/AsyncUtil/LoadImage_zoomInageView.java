...
public class LoadImage_zoomInageView extends AsyncTask<String, integer, Boolean> {
	private ZoomImageView imageView;
	private String imagePath;
	private Boolean IsShow=true; //true 为显示  false不显示
	public LoadImage_zoomInageView(ZoomImageView imageView,String imageUrl,Context context) {
		// TODO Auto-generated constructor stub
		this.imageView = imageView;

		imagePath = MyFlg.setImageFileName(imageUrl,context);
	}
	public LoadImage_zoomInageView(String imageUrl,Context context) {
		// TODO Auto-generated constructor stub
		IsShow = false;
		imagePath = MyFlg.setImageFileName(imageUrl,context);
